...
export function isValidTransition(
  ...
  const validTransitions: Record<UserStateType, UserStateType[]> = {
    ...
    VOICE_RECEIVED: ['IMAGE_PENDING', 'VOICE_RECEIVED', 'CONFIRMATION_PENDING', 'KYC_VERIFIED', 'GUEST_ACTIVE', 'ACTIVE'],
    IMAGE_PENDING: ['CONFIRMATION_PENDING', 'KYC_VERIFIED', 'GUEST_ACTIVE', 'ACTIVE'],
    CONFIRMATION_PENDING: ['ACTIVE', 'VOICE_RECEIVED', 'KYC_VERIFIED', 'GUEST_ACTIVE'],
